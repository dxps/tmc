...
pub fn Login() -> Element {
    ...
    rsx! {
        div {
            ...
            div { class: "flex flex-col min-h-screen justify-center items-center m-8 drop-shadow-2xl",
                div { class: "bg-white rounded-md p-6",
                    div { class: "text-xl my-6 px-2 text-center text-gray-600",
                        "Login to your account"
                    }
                    div { class: "mt-4 space-y-4",
                        div {
                            input {
                                class: "px-4 py-3 rounded-lg outline-none border-2 focus:border-green-500",
                        ...
                        div { class: "justify-center text-center my-8",
                            button {
                                class: "bg-green-50 drop-shadow-sm px-4 py-2 rounded-md",
                                onclick: move |_| {
