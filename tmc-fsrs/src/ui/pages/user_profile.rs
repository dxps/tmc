                ...
                div { class: "bg-white rounded-md p-6 mt-24 mb-8",
                    ...
                    div { class: "mt-8 space-y-6",
                        div {
                            ...
                            input {
                                class: "w-full rounded-md py-2.5 px-4 border text-sm outline-green-300",
                                r#type: "text", placeholder: "Username",
                                value: "{ua.username}", maxlength: 48
                            }
                        }
                        div {
                            ...
                            input {
                                class: "w-full rounded-md py-2.5 px-4 border text-sm outline-green-300",
                                r#type: "text", placeholder: "Email",
                                value: "{ua.email}", maxlength: 64
                            }
                        }
                        div {
                            ...
                            textarea {
                                class: "w-full rounded-md py-2.5 px-4 border text-sm outline-green-300",
                                cols: 64, rows:8, placeholder: "Biography",
                                value: "{ua.bio}", maxlength: 1024
                            }
                        }
                        div { class: "text-center my-8",
                            button {
                                ...
                                onclick: move |_| {
                                    async move {
                                        // TODO Use a server fn
                                        // handle_save(ua.username, ua.email, ua.bio).await;
                                    }
                                },
                                "Save"
                            }
